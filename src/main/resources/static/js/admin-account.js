...
document.addEventListener("DOMContentLoaded", function() {
    ...
    const searchUsername = urlParams.get('searchUsername');
    if (searchUsername && searchUsername.trim() !== '') activeTags.push({ text: searchUsername.trim(), inputName: 'searchUsername' });
